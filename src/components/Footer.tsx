    ...
    <div className="bg-blue-dark w-full px-5 text-white font-sugo">
      <footer className="flex flex-col mx-auto max-w-7xl">
        <div className="flex flex-col md:flex-row md:justify-evenly items-center py-3">
          ...
          <div className="space-y-4">
            <picture className="flex justify-around">
              <img
                className="w-20"
                src="/img/footer/unifei-logo.svg"
                alt="Logotipo da Universidade Federal de Itajubá"
              />
              <img
                className="w-20"
                src="/img/footer/danada-logo.svg"
                alt="Logotipo da bateria danada com um coelho de óculos segurando um surdo de marcação na mão direita"
              />
            </picture>
          ...
          <div className="mt-5 mb-8 space-y-4">
            ...
            <div className="flex flex-col lg:flex-row justify-evenly items-center md:items-start lg:items-center gap-x-8 gap-y-4">
              <a
                ...
                href="mailto:bateriadanadaunifei@gmail.com"
              >
                <span>
                  bateriadanadaunifei<span className="font-mono">@</span>
                  gmail.com
                </span>
                <img
                  className="hover:scale-105 transition-all md:-order-1 md:w-6 lg:w-9"
              ...
              >
                ...
                <img
                  className="hover:scale-105 transition-all md:-order-1 md:w-6 lg:w-auto"
                  src="/img/footer/instagram-icon.svg"
                  alt=""
                />
              </a>
              <a
        ...
        <div className="">
          <hr />
          <img
            className="px-14 pt-2 mx-auto"
            src="/img/footer/devbsol.svg"
            alt="Logotipo por extenso da empresa byron solutions"
          />
        </div>
      </footer>
    </div>
