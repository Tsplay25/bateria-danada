...
export default function Header() {
  ...
  return (
    <>
      <header className="flex bg-blue-dark px-5 py-3 justify-center">
        <div className="flex w-full max-w-7xl items-center justify-between">
          {/* logos */}
          <div className="flex mb-1">
            <img
              className="md:h-16"
              src="/img/header/logo-coelhoBD.svg"
              alt="logotipo bateria danada branca com um coelho e a sigla B.D de fundo"
            />
            <img
              className="hidden md:block"
              src="/img/header/logo-escrita.svg"
              alt="logotipo bateria danada escrito por extenso"
            />
          </div>
          ...
          <nav className="flex items-center pr-10">
            <ul className="hidden xl:flex items-center text-white bg-blue-dark text-[32px] gap-8 font-sugo antialiased h-full">
              ...
              <li className="group flex justify-center items-center relative z-10">
                <a className="block z-20 text-center absolute" href="#social">
                  Social
                </a>
                <img
                  className="z-10 opacity-0 group-hover:opacity-100 transition-all duration-200 w-24"
          ...
          >
            <img
              ...
              src="/img/header/hamburger-menu.svg"
              alt=""
            />
          </button>
        </div>
      ...
      <div
        className={`${
          showMenu ? "max-h-64" : "max-h-0 invisible"
      ...
      >
        <ul className="flex flex-col items-center text-white bg-blue-dark text-2xl font-sugo antialiased">
          <li className="py-1.5 hover:bg-blue-regular transition-all w-full">
            <a className="flex justify-center" href="#hero">
              Home
            </a>
          </li>
          <li className="py-1.5 hover:bg-blue-regular transition-all w-full">
          ...
          <li className="py-1.5 hover:bg-blue-regular transition-all w-full">
            <a className="flex justify-center" href="#social">
              Social
            </a>
          </li>
          <li className="py-1.5 hover:bg-blue-regular transition-all w-full">
